...
public class BookCopy {
    ...
    private final StringProperty  spineLevel;
    private final StringProperty  status;

    public BookCopy(int id, int bookId,
                    String accessionNumber, String spineLevel, String status) {
        this.id              = new SimpleIntegerProperty(id);
        this.bookId          = new SimpleIntegerProperty(bookId);
        this.accessionNumber = new SimpleStringProperty(accessionNumber);
        this.spineLevel      = new SimpleStringProperty(spineLevel);
    ...
    public String getSpineLevel()      { return spineLevel.get(); }
    public String getStatus()          { return status.get(); }

    public IntegerProperty idProperty()              { return id; }
    public StringProperty  accessionNumberProperty() { return accessionNumber; }
    public StringProperty  spineLevelProperty()      { return spineLevel; }
